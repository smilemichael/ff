chart = new Highcharts.Chart({
  chart: {
    ...
    title:{
        text: "West Little Llagas below Edmundson"
    },
    xAxis: {
        gridLineWidth: 1,
        ...
        min: sta117_histFlow[0][0],
        max: sta117_fcFlow[sta117_fcFlow.length-1][0]
    },
    yAxis: {
        lineWidth:1,
        title: {
        ...
        min: 0,
        minRange: sta117_floodWarning + 500
    },
    legend: {
        layout: "vertical",
        align: "right",
